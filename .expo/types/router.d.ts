...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/forgot-password` | `/forgot-password` | `/(auth)/login` | `/login` | `/(auth)/register` | `/register` | `/(tabs)/credit` | `/credit` | `/(tabs)/` | `/(tabs)` | `/(tabs)/insurance` | `/insurance` | `/(tabs)/loans` | `/loans` | `/(tabs)/profile` | `/profile` | `/credit-apply` | `/edit-profile` | `/how-it-works` | `/improve-score` | `/increase-earnings` | `/fica-upload`;
  // prettier-ignore
